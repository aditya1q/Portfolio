...
const Hero = () => {
  return (
    <div
      className='z-[1] w-full flex flex-col lg:flex-row bg-black text-white justify-center gap-20 lg:justify-around items-center h-[130vh] sm:h-[140vh] md:h-[150vh] lg:h-screen'
    >
      <div className='flex flex-col text-center items-center justify-center gap-5'>
        ...
        <h1 className='text-lg font-medium animate-fadeIn-2'>Hello, It's Me</h1>
      ...
      <div className='flex items-center justify-center mr-0 lg:mr-24'>
        <img src="../assests/pg.png" alt="" className='image object-contain flex items-center justify-center w-[70%] lg:w-[95%] ' />
      </div>
    </div>
  );
};
